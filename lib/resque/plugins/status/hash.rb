    ...
    module Status
      ...
      class Hash < ::Hash
        class << self
          ...
          def statuses(range_start = nil, range_end = nil)
            ids = status_ids(range_start, range_end)
            mget(ids).compact || []
          end

          # Return the <tt>num</tt> most recent status/job UUIDs in reverse chronological order.
          def status_ids(range_start = nil, range_end = nil)
          ...
          def killall(range_start = nil, range_end = nil)
